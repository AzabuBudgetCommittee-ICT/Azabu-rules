...
rule_idは14桁の文字列であり、以下の要素で構成される。
...
### 例
2024年予算委員会規約第1号による改正を経た2023年予算委員会規約第1号（2024年11月6日施行）
`2023CON1000011_20241106_2024CON1000011`
- `2023CON1000011` -> 規則類id
- `20241106` -> 2024年11月6日施行
- `2024CON1000011` -> 改正を行った規則類id
